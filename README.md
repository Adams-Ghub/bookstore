...
**Bookstore** is a Single Page Application website that allows a user to perform crud operations on a list of books.
...
- **Books page:** This is a page that list all the books that have been added.
- **Categories:** This is also a page where the user gets to see the books organized in categories.
